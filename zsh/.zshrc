...
export ZSH="/Users/enelson/.oh-my-zsh"
...
## eval "$(oh-my-posh init zsh --config '/opt/homebrew/opt/oh-my-posh/themes/powerline.omp.json')"
...
plugins=(git brew vscode zsh-autosuggestions zsh-syntax-highlighting web-search)
